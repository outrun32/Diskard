  ...
  return <div className={cn("app-frame",collapsed&&"app-sidebar-collapsed")}>
    ...
    <aside className={cn("sidebar",collapsed&&"sidebar-collapsed")}>
      ...
      <div className="sidebar-bottom">
        {!collapsed && <div className="sidebar-concepts"><a href="https://github.com/outrun32/Diskard/blob/feat/generic-chat-probe-adapter/docs/showcase/README.md" target="_blank" rel="noreferrer" className="sidebar-github-link"><Github size={14}/> GitHub</a><span className="nav-label">🐢 Черепашки атакуют</span><a href="/concepts/soc-dashboard.html" target="_blank" rel="noreferrer">SOC dashboard</a><a href="/concepts/attack-graph.html" target="_blank" rel="noreferrer">Attack graph</a><a href="/concepts/attack-graph-v2.html" target="_blank" rel="noreferrer">Attack graph v2</a></div>}
