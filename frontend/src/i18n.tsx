...
const messages = {
  en: {
    ...
    fullRuns: "Full attacks", individualRuns: "Individual runs", combinedReport: "Generate report",
  ...
  ru: {
    ...
    fullRuns: "Полные атаки", individualRuns: "Отдельные запуски", combinedReport: "Сформировать отчёт",
