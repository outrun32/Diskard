...
const messages = {
  en: {
    ...
    executionMode: "Execution mode", standardAttack: "Standard attack", llmAttack: "Automatic attack with LLM", verifiedScenario: "Verified scenario", runVerifiedScenario: "Run verified scenario", verifiedScenarioHint: "Runs a checked scenario against the target and streams a live trace.",
    ...
    fullAttackHint: "Runs every available attack and produces one report.",
    ...
    individualRuns: "Individual runs", combinedReport: "Generate report",
  ...
  ru: {
    ...
    executionMode: "Режим выполнения", standardAttack: "Стандартная атака", llmAttack: "Автоматическая атака с LLM", verifiedScenario: "Проверочный сценарий", runVerifiedScenario: "Запустить проверочный сценарий", verifiedScenarioHint: "Запускает проверенный сценарий на цели и показывает живую трассировку.",
    ...
    fullAttackHint: "Запускает все доступные атаки и создаёт один отчёт.",
    ...
    individualRuns: "Отдельные запуски", combinedReport: "Сформировать отчёт",
